...
def execute():
	...
	black_folder = "/home/pierre/dev/leek-wars/static/image/chip/black/"
	output_folder = "/home/pierre/dev/leek-wars/static/image/chip/big/"
	output_small_folder = "/home/pierre/dev/leek-wars/static/image/chip/small/"
	glyph_folder = "/home/pierre/dev/leek-wars/static/image/chip/glyph/"
	...
	chips = {
		...
		'heal':   ['bandage', 'cure', 'drip', 'vaccine', 'loam', 'regeneration', 'remission',
				   'fertilizer', 'resurrection', 'armoring'],
	...
	for (i, file) in enumerate(files):
		...
		pdb.gimp_context_set_foreground(light_color(color[0], 20))
		pdb.gimp_context_set_background(light_color(color[1], 55))
		pdb.gimp_edit_blend(calque3, FG_BG_RGB_MODE, NORMAL_MODE, GRADIENT_LINEAR, 100, 0, 0, FALSE, TRUE, 3, 0.2, TRUE, 0, 0, 0, 280)
		
		# Dessin (en degrade)
		pdb.gimp_selection_layer_alpha(drawable)
		pdb.gimp_context_set_foreground(dark_color(color[0], 40))
		pdb.gimp_context_set_background(dark_color(color[1], 20))
